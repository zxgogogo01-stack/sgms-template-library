...
- 1 个文章索引、至少 12 个文章槽位，其中至少 2 个 cornerstone 槽位、至少 1 个承载注册/邀请码内容的页面外壳。模板不代写教程正文；文章骨架至少提供 3 种首屏/开场结构，H2、FAQ、目录与收尾不是全站同款。
...
- `registrationGuide` 页面外壳保留且只保留 1 个静态 `href` 注册链接槽位，带 `target="_blank"` 与 `rel="sponsored nofollow noopener noreferrer"`，旁边有可替换的披露文字；其他信息、工具、合规、列表、404、导航和页脚没有转化直链。
